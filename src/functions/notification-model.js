...
//       console.log("[notif:mail] driver=", driverName, "audience=", audience);
//       console.log("[notif:mail] recipients=", to || bcc);
...
//       };
//       
//       // Only include replyTo if the current driver is NOT Resend
//       if (driverName !== 'resend') {
//         mailOptions.replyTo = `${replyToName} <${replyToEmail}>`;
//       } else {
//            // Resend requires Reply-To to be passed in a separate headers object
//            mailOptions.headers = {
...
//       // 💡 CRASH PREVENTION FIX: Ensure info is valid before accessing messageId
//       if (!info || typeof info.messageId !== 'string') {
//           console.error(`📧 Email sent failed or returned incomplete info (${audience}).`);
